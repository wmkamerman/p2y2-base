...
class P2AssetBundle extends \yii\web\AssetBundle
{
	...
	private static $_p2mPath = '@vendor/p2made/yii2-p2y2-moment-timezone/assets/lib';
	...
	{
		$target = str_replace('@p2m@', '@vendor/p2made/yii2-p2y2-moment-timezone/vendor', $target);
	}
